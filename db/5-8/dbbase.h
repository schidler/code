...
//////////////////////////////////////////////////////////
//数据表名称定义
const u8 DB_NAME[] = "HuaRuiCloud";
const u8 DB_TABLE_HOSTINFO[] = "HostInfo";
const u8 DB_TABLE_NATIVERTU[] = "NativeRtu";
const u8 DB_TABLE_SCENEINFO[] = "SceneInfo";
const u8 DB_TABLE_SCENEINFOCONTINUED[] = "SceneInfoContinued";
const u8 DB_TABLE_SCENERTU[] = "SceneRtu";
const u8 DB_TABLE_TRANSPONRTU[] = "TransponRtu";
const u8 DB_TABLE_SAFETYRTU[] = "SafetyRtu";
const u8 DB_TABLE_SAFETYPWD[] = "SafetyPwdInfo";
const u8 DB_TABLE_SAFETYSET[] = "SafetySetBind";
const u8 DB_TABLE_SAFETYREMOVE[] = "SafetyRemoveBind";
const u8 DB_TABLE_APPRTU[] = "AppRtu";
const u8 DB_TABLE_DETECTORRTU[] = "DetectorRtu";
const u8 DB_TABLE_DETECTORBIND[] = "DetectorBind";
const u8 DB_TABLE_TASKINFO[] = "TaskInfo";
const u8 DB_TABLE_EXNATIVERTU[] = "ExNativeRtu";
const u8 DB_TABLE_RTUTYPE[] = "RtuTypeInfo";
const u8 DB_TABLE_USEDEVTYPE[] = "UseDevTypeInfo";
//const u8 DB_TABLE_UPDATEPACKINFO[] = "UpdatePackInfo";
...
{	
	...
	u32  hostip;                      //  主机  ip ：  bytes[3:2:1:0]
