...
int CEpollClient::RecvFromServer(int iUserId,char *pRecvBuff,int iBuffLen)
{
        ...
        if(1/*SEND_OK == m_pAllUserStatus[iUserId].iUserStatus*/)
        {
...
{
	CEpollClient *pCEpollClient = new CEpollClient(20000, "192.168.0.73", 9880);
	//CEpollClient *pCEpollClient = new CEpollClient(1000, "183.63.118.58", 9884);
